...
var knifeImage , fruit1, fruit2 ,fruit3,fruit4, monsterImage, sound,sound1,gameOverImage,gameover;
...
function preload(){
  ...
  sound1=loadSound("mixkit-sad-game-over-trombone-471 (1).wav");
  //load sound here
}
...
function fruits(){
  if(World.frameCount%80===0){
    position = Math.round(random(1,1));
